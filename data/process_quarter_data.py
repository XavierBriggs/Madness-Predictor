...
def compute_team_per_quarter_matrix(csv_file):
    ...
    df["QuarterID"] = pd.cut(df["DayNum"], bins=[-1, 33, 66, 99, 132], labels=[1, 2, 3, 4])
    ...
    feature_columns = ["Season", "QuarterID", "TeamID", "TS%", "eFG%", "TO%", "OREB%", "DREB%", "FTR", "3PAr", "AST/TO", "STL%", "BLK%", "PointsPerPoss"]
...
team_matrix.to_csv("processed/teams_by_quarter.csv", index=False)
print("Done")
